...
<?php
include('session.php');
$query="select * from item_list where shop_id=(select shop_id from shop_list 
where username like '$user_check')";       
...
else
{
    ...
    {
        $item_id=$row['item_id'];
        echo "<tr><td>".$row["item_id"]."</td><td>".$row["name"]."</td><td>".$row["price"]."</td><td>".$row["unit"]."</td><td>".$row["category"]."</td><td>".$row["default_quantity"]."</td><td>".$row["isAvailable"]."</td><td>";
        echo "<br><form method='POST' action='modify.php'>
            <input type='submit' value='Modify'>
            <input type='hidden' name='item_id' value=\"$item_id\"/>
            </form>";
        echo "</td><td>";
		echo "<br><br><form method='POST' action='deleteitem.php'>
